...
class CivilAISettings:
    ...
    free_monthly_token_limit: int = field(default_factory=lambda: int(os.getenv("FREE_MONTHLY_TOKEN_LIMIT", "100000")))
    standard_monthly_token_limit: int = field(default_factory=lambda: int(os.getenv("STANDARD_MONTHLY_TOKEN_LIMIT", "1000000")))
    pro_monthly_token_limit: int = field(default_factory=lambda: int(os.getenv("PRO_MONTHLY_TOKEN_LIMIT", "5000000")))
