...
class AuditLogAgent(BaseAgent):
    ...
    REQUIRED_EVENTS = {
        ...
        "api.query": "backend/Features/API_management/Tools/v1.py",
        "api.query.stream": "backend/Features/API_management/Tools/v1.py",
        "custom.query": "backend/Features/RAG_management/rag_api.py",
        "upload.pdf.start": "backend/Features/RAG_management/rag_api.py",
        "upload.pdf.success": "backend/Features/RAG_management/rag_api.py",
        "security.rate_limit": "backend/Features/Runtime_management/backend_run.py",
    }
