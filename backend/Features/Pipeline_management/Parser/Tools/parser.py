...
from backend.Features.Database_management.Builders.chroma import (
    ChromaManager,
    create_runtime_vector_manager,
)
from backend.Features.Database_management.Builders.DB import DatabaseManager
...
class ParserComponentFactory:
    ...
    def create_default_paths(backend_root: Path | None = None) -> ParserPaths:
        resolved_backend_root = backend_root or Path(__file__).resolve().parents[4]
