...
from backend.Features.API_management.Tools.v1 import router as api_v1_router
from backend.Features.RAG_management.rag_api import app as custom_app
...
from backend.Features.User_management.auth_run import router as auth_router
...
# Include auth and CivilAI RAG routes under one stable backend contract.
